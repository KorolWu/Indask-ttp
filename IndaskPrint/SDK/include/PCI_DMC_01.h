...
//20120823
//I16 PASCAL _DMC_01_set_cv_mode(I16 CardNo, U16 NodeID, U16 SlotID, U16 flag_const_v, U16 flag_dec_c);//flag_const_v=1,等速段 等速模式,flag_dec_c=1,加減速段最後一筆(不足的DDA與下個指令結合)
I16 PASCAL _DMC_01_set_cv_mode(I16 CardNo, U16 NodeID, U16 SlotID, U16 flag_const_v);//flag_const_v=1,等速段 等速模式,flag_dec_c=1,加減速段最後一筆(不足的DDA與下個指令結合)
...
//mode = 2 時	New_Speed*feedrate為FeedRate的變動倍率值 exp: New_Speed=100000,feedrate=0.0001,SPD=5000,->產生結果 NEW_SPD = SPD*New_Speed*feedrate=50000
...
//關閉_DMC_01_start_v3_ellipse_xy 不開放使用 2016-12-16
...
//20150529
I16 PASCAL _DMC_01_sd_buffer_link(U16 CardNo, U16 NodeID, U16 SlotID,F64 Tdec);//使用speed continue 時,可以中斷目前運動指令,執行在buffer中新的指令 
...
//20151110
I16 PASCAL _DMC_A02_mpg_get_poisition(U16 CardNo, I32* nValue);  //get 手輪的counter
I16 PASCAL _DMC_A02_mpg_fsm_get_lock_state(U16 CardNo, U8* nState);   // nState: [0]Unlock  [1]Lock  a02手輪的counter致能
I16 PASCAL _DMC_A02_mpg_get_io_state_enable(U16 CardNo, U8* nState);  // nState: [0]Disable  [1]Active 控制手輪pulse input 的閂鎖器
I16 PASCAL _DMC_A02_mpg_axis_get_io_state(U16 CardNo, U8* nState);
// nState: [0]None  [1]Axis#0  [2]Axis#1  [3]Axis#2  [4]Axis#3  手輪軸選擇
...
I16 PASCAL _DMC_A02_set_jog_axes_enable(U16 CardNo, U16* NodeID, U16* SlotID,U16 enable,U16 jog_mode,I32 *jog_speed,F64 *sec);  //jog_mode0->6button 有效,1->手輪選擇軸,xbutton控制jog方向
...
// nState: [0]None  [1]Axis#0  [2]Axis#1  [3]Axis#2  [4]Axis#3 ...[10]Axis#9  手輪軸選擇
...
I16 PASCAL _DMC_01_set_dda_data_group(U16 CardNo,U16 GroupNo, U32* abs_pos);   //abs_pos : 12個
...
//torque_ratio P1-87 歸零轉矩 (1~300) 單位 %
//qualified_ms P1-88 轉矩到達確認時間 (2~2000) 單位 ms qualified 
//max_torque_ratio P2-42 最大運動轉矩 (0~10) 單位 %
...
//2017-02-22
I16 PASCAL _DMC_01_set_dio_input_int_flag_clear(U16 CardNo);//RD Debug用，不開放。
//2017-02-22
I16 PASCAL _DMC_01_get_dio_input_int_flag(U16 CardNo, U16* DI_int_flag);//RD Debug用，不開放。
//2017-02-24
...
//2017-12-08
I16 PASCAL _DMC_01_ROUNDING(U16 CardNo, U16 Enable);//運算Cycle最後一步<1, 在倒數第二步將小數部分補足 
